...
const DEFAULT_APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbwOQukOfjc5ZXmG8kn7FldhRdgi1_w5lRssU2cQu0oeQ-FL88EjEMd23UIf7MqvorTp/exec";
...
export default function App() {
  ...
  const [appsScriptUrl, setAppsScriptUrl] = useState<string>(() => {
    return localStorage.getItem('jj_apps_script_url') || DEFAULT_APPS_SCRIPT_URL;
  });
  ...
  useEffect(() => {
    localStorage.setItem('jj_apps_script_url', appsScriptUrl);
  }, [appsScriptUrl]);
