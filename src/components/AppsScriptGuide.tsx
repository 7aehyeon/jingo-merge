          ...
          "parts": [
            ...
            },
            {
              "text": "이 이수증/수료증 PDF 파일의 텍스트와 레이아웃을 정밀하게 분석하여 다음 정보들을 추출해줘:\\n" +
                      "1. certNumber: 이수번호 혹은 등록번호 (파일에 쓰여있는 그대로 추출, 예: 제 2026-다문화-01호)\\n" +
                      "2. certDate: 이수 완료일자 혹은 수료 날짜 (반드시 YYYY-MM-DD 형식으로 정밀 변환, 예: 2026-06-15)\\n" +
                      "3. hours: 이수 시간 또는 연수 시간 (정수 숫자만 기재, 예: 15)\\n" +
                      "4. userName: 수혜자로 표기된 교직원 성명\\n" +
                      "5. trainingTitle: 연수 과정명"
            }
          ]
        }],
        "generationConfig": {
